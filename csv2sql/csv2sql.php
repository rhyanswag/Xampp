...
<form class="form-horizontal"action="csv2sql.php" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-3">
        <input type="text" class="form-control" name="db" id="db" placeholder="" value="logs" >
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-3">
        <input type="name" class="form-control" name="table" id="table" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="csvfile" class="control-label col-xs-2">Name of the file</label>
        <div class="col-xs-3">
        <input type="name" class="form-control" name="csv" id="csv" placeholder="eg. MYDATA.csv">
        </div>
...
if(isset($_POST['username'] )&& isset($_POST['mysql']) && isset($_POST['db']) && isset($_POST['username'])) {
    ...
    $db = $_POST['db'];
    $file = $_POST['csv'];
    $cons = mysqli_connect("localhost", "root", "", "logs") or die(mysql_error());

    $truncate = mysqli_query($cons, "TRUNCATE TABLE $table");
    ...
    if ($count1 == 0) {
        ...
        echo "Table $table not truncated<br>";
    }
